...
var nicEditorConfig = bkClass.extend({
	buttons : {
		'bold' : {name : __('Kalın Yazı'), command : 'Bold', tags : ['B','STRONG'], css : {'font-weight' : 'bold'}, key : 'b'},
		'italic' : {name : __('İtalik Yazı'), command : 'Italic', tags : ['EM','I'], css : {'font-style' : 'italic'}, key : 'i'},
		'underline' : {name : __('Altı Cizili Yazı'), command : 'Underline', tags : ['U'], css : {'text-decoration' : 'underline'}, key : 'u'},
		...
		'ul' : 	{name : __('İmli Liste'), command : 'insertunorderedlist', tags : ['UL']},
		'subscript' : {name : __('Click to Subscript'), command : 'subscript', tags : ['SUB']},
		'superscript' : {name : __('Click to Superscript'), command : 'superscript', tags : ['SUP']},
		'strikethrough' : {name : __('Click to Strike Through'), command : 'strikeThrough', css : {'text-decoration' : 'line-through'}},
		'removeformat' : {name : __('Remove Formatting'), command : 'removeformat', noActive : true},
		'indent' : {name : __('Girintiyi Azalt'), command : 'indent', noActive : true},
		'outdent' : {name : __('Girintiyi Arttır'), command : 'outdent', noActive : true},
...
var nicLinkOptions = {
	buttons : {
		'link' : {name : 'Bağlntı Ekle', type : 'nicLinkButton', tags : ['A']},
		'unlink' : {name : 'Bağlantı Kaldır',  command : 'unlink', noActive : true}
	}
};
/* END CONFIG */
...
var nicImageOptions = {
	buttons : {
		'image' : {name : 'Yeni Resim', type : 'nicImageButton', tags : ['IMG']}
	}
...
var nicUploadButton = nicEditorAdvancedButton.extend({
  ...
  errorText : 'Hata! Resim Yüklenemedi',
